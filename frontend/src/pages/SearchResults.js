...
const SearchResults = (props) => {
     ...
     const fetchData = async () => {
          ...
          const URL = `${process.env.REACT_APP_API_URL}/products/query/${keyword}?page=${page}&limit=${limit}`
          ...
          <div className="flex flex-wrap" id="productContainer">
               ...
               { products.length !== 0 &&
                    ...
                    <div className='not-found-wrapper'>
                         <h1 className='not-found-title'>Results for "{keyword}" is not availble...</h1>

                         <img className='flex-box not-found-image' src="https://www.shutterstock.com/image-vector/document-file-not-found-search-260nw-2172684639.jpg" />
                         </div>
                    }
          </div>
     );
